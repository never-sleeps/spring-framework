...
public class ShellBooks {
    ...
    public String updateBook(@ShellOption String id) {
        ...
        return String.format("Данные книги с ID %s успешно обновлены: %s\n", id, book.toString());
    }
    ...
    public String deleteBook(@ShellOption String id) {
        ...
        return String.format("Книга с id '%s' была удалена\n", id);
    }
    ...
    public String getBookById(@ShellOption String id) {
        ...
        return (book.isPresent()) ? String.format("Книга с id '%s': %s\n", id, book.toString())
                : String.format("В библиотеке нет книги  с id '%s'\n", id);
    }
